...
import SponsorDetailsStep from '../Steps/SponsorDetailsStep';
import EventDetailsStep from '../Steps/EventDetailsStep';
import EventCommentStep from '../Steps/EventCommentStep';
import EventTitleStep from '../Steps/EventTitleStep';
...
const onSubmitForm = async(event) => {
  ...
  try{
    const response = await fetch("http://localhost:5000/send-create-event", {
        method: "POST",
        headers: {
    ...
    //this will all need to be removed as an fyi
    console.log(data)
    try{
        const body = data
...
const steps = [
    ...
    return(
        ...
        {activeStep === steps.length && (
            ...
            <Typography>Succesfully Submited - check email regularly for confirmation</Typography>
